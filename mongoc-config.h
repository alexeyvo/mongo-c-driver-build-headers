...
#define MONGOC_CC "C:/Program Files (x86)/Microsoft Visual Studio 12.0/VC/bin/x86_amd64/cl.exe"
 ...
 * update:
 * o The bitfield in mongoc-metadata-private.h
 * o _get_config_bitfield() in mongoc-metadata.c
 * o metadata_script.py
 */
